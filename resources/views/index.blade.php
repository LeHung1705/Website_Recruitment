...
<div class="container">
    ...
    <div class="featured-categories">
        ...
        <div class="category-grid">
            <a href="#" class="category-card">
                ...
                <span class="job-count">300+ việc làm</span>
            </a>
            <a href="#" class="category-card">
                <div class="category-icon">
                ...
                <h3>Kinh doanh</h3>
                <span class="job-count">250+ việc làm</span>
            </a>
            <a href="#" class="category-card">
                <div class="category-icon">
                ...
                <h3>Thiết kế</h3>
                <span class="job-count">150+ việc làm</span>
            </a>
            <a href="#" class="category-card">
                <div class="category-icon">
                ...
                <span class="job-count">200+ việc làm</span>
            </a>
        </div>
    </div>
    ...
    <div class="job-list-container">
        <div class="section-header">
            ...
            <a href="{{ route('jobs.index') }}" class="view-all">Xem tất cả <i class="fas fa-arrow-right"></i></a>
        </div>
        <div class="job-list">
